  ...
  "inline-flex items-center rounded-md border px-2 py-0.5 text-caption-medium transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        success: "border-transparent bg-status-success text-primary-foreground",
        warning: "border-transparent bg-status-warning text-primary-foreground",
        error: "border-transparent bg-status-error text-primary-foreground",
      },
    },
